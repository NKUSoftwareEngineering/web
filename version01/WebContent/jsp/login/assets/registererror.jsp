...
<html lang="en">
    ...
    <head>
        ...
        <!-- CSS -->
        <link rel="stylesheet" href="/SnowBall/jsp/register/assets/bootstrap/css/bootstrap.min.css">
        <link rel="stylesheet" href="/SnowBall/jsp/register/assets/css/style.css">
        <style type="text/css">
        #apDiv1 {
	position: absolute;
	width: 229px;
...
dsy.add("0_25",["天津"]);
dsy.add("0_25_0",["南开","红桥","和平","河西","河东","北辰","河北"]);
dsy.add("0_30",["重庆"]);
...
//-->
    ...
    <body onLoad="setup()">
        ...
        <div class="register-container container">
            <div class="row">
                ...
                <div class="register span6">
                    <form action="/SnowBall/jsp/register/register.jsp" id="CustomerForm" method="post">
                        <h2>注册<span class="red"><strong>失败</strong></span></h2>
                        
       					 <h2><span class="red"><strong>用户名已存在</strong></span></h2>
        ...
        <!-- Javascript -->
        <script src="/SnowBall/jsp/register/assets/js/jquery-1.8.2.min.js"></script>
        <script src="/SnowBall/jsp/register/assets/bootstrap/js/bootstrap.min.js"></script>
        <script src="/SnowBall/jsp/register/assets/js/jquery.backstretch.min.js"></script>
        <script src="/SnowBall/jsp/register/assets/js/scripts.js"></script>
        <SCRIPT LANGUAGE="JavaScript">
