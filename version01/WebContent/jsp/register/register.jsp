...
dsy.add("0_12_3",["相山区","杜集区","烈山区","濉溪县","濉溪镇"]);
dsy.add("0_12_4",["谯城区","涡阳县","城关镇","蒙城县","城关镇","利辛县","城关镇"]);
dsy.add("0_12_5",["颍州区","颍东区","颍泉区","界首市","临泉县","城关镇","太和县","城关镇","阜南县","城关镇","颍上县","慎城镇"]);
dsy.add("0_12_6",["蚌山区","龙子湖区","禹会区","淮上区","怀远县","城关镇","五河县","城关镇","固镇县","城关镇"]);
dsy.add("0_12_7",["田家庵区","大通区","谢家集区","八公山区","潘集区","凤台县","城关镇"]);
dsy.add("0_12_8",["琅区","南谯区","明光市","天长市","来安县","新安镇","全椒县","襄河镇","定远县","定城镇","凤阳县","府城镇"]);
dsy.add("0_12_9",["雨山区","花山区","金家庄区","当涂县","姑孰镇"]);
dsy.add("0_12_10",["镜湖区","弋江区","三山区","鸠江区","芜湖县","湾镇","繁昌县","繁阳镇","南陵县","籍山镇"]);
dsy.add("0_12_11",["铜官山区","狮子山区","郊区","铜陵县","五松镇"]);
dsy.add("0_12_12",["迎江区","大观区","宜秀区","桐城市","怀宁县","高河镇","枞阳县","枞阳镇","潜山县","梅城镇","太湖县","晋熙镇","宿松县","孚玉镇","望江县","雷阳镇","岳西县","天堂镇"]);
dsy.add("0_12_13",["屯溪区","黄山区","徽州区","歙县","徽城镇","休宁县","海阳镇","黟县","碧阳镇","祁门县","祁山镇"]);
dsy.add("0_12_14",["金安区","裕安区","寿县","寿春镇","霍邱县","城关镇","舒城县","城关镇","金寨县","梅山镇","霍山县","衡山镇"]);
dsy.add("0_12_15",["居巢区","庐江县","庐城镇","无为县","无城镇","含山县","环峰镇","和县","历阳镇"]);
dsy.add("0_12_16",["贵池区","东至县","尧渡镇","石台县","七里镇","青阳县","蓉城镇"]);
dsy.add("0_12_17",["宣州区","宁国市","郎溪县","建平镇","广德县","桃州镇","泾县","泾川镇","旌德县","旌阳镇","绩溪县","华阳镇"]);
...
dsy.add("0_19",["广州市","深圳市","清远市","韶关市","河源市","梅州市","潮州市","汕头市","揭阳市","汕尾市","惠州市","东莞市","深圳市","珠海市","中山市","江门市","佛山市","肇庆市","云浮市","阳江市","茂名市","湛江市"]);
...
dsy.add("0_19_11",["福田区","罗湖区","南山区","宝安区","龙岗区","盐田区"]);
dsy.add("0_19_12",["香洲区","斗门区","金湾区"]);
dsy.add("0_19_13",["江海区","蓬江区","新会区","恩平市","台山市","开平市","鹤山市"]);
dsy.add("0_19_14",["禅城区","南海区","顺德区","三水区","高明区"]);
dsy.add("0_19_15",["端州区","鼎湖区","高要市","四会市","广宁县","南街镇","怀集县","怀城镇","封开县","江口镇","德庆县"]);
dsy.add("0_19_16",["云城区","罗定市","云安县","六都镇","新兴县","新城镇","郁南县","都城镇"]);
dsy.add("0_19_17",["江城区","阳春市","阳西县","织镇","阳东县","东城镇"]);
dsy.add("0_19_18",["茂南区","茂港区","化州市","信宜市","高州市","电白县","水东镇"]);
dsy.add("0_19_19",["赤坎区","霞山区","坡头区","麻章区","吴川市","廉江市","雷州市","遂溪县","遂城镇","徐闻县","撤销广州市东山区","芳村区","设立广州市南沙区","萝岗区"]);
...
dsy.add("0_21_1",["文昌市","琼海市","万宁市","五指山市","东方市","儋州市","临高县","临城镇","澄迈县","金江镇","定安县","定城镇","屯昌县","屯城镇","昌江黎族自治县","石碌镇","白沙黎族自治县","牙叉镇","琼中黎族苗族自治县","营根镇","陵水黎族自治县","椰林镇","保亭黎族苗族自治县","保城镇","乐东黎族自治县","抱由镇"]);
            ...
            <div class="container">
                <div class="row">
                    <div class="logo span4">
                        <h1><a href="">转 转<span class="blue"></span></a></h1>
                    </div>
        ...
        <div class="register-container container">
            <div class="row">
                ...
                <div class="register span6">
                    <form action="/version01/RegisetServlet" id="CustomerForm" method="post">
                        <h2>Register To <span class="red"><strong>转转网</strong></span></h2>
                        <label for="loadname">登录名</label>
                        <input type="text" id="loadname"  name="cuname" maxlength="64" placeholder="请输入您的用户名...">
                        <label for="password">密码</label>
                         <input type="password" id="password" name="cupassword" maxlength="20" placeholder="请输入8～20字符，需同时包含英文和数字...">
                        <label for="confirpwd">确认密码</label>
                         <input type="password" id="confirpwd" name="confirpwd" maxlength="20" placeholder="请再次输入密码...">
                        <label for="email">邮箱</label>
                         <input type="text" id="email" name="cuemail" maxlength="30" placeholder="请输入您的邮箱...">
                        
        
         <button type="submit" onClick="toFSC05110E01(this); return false;">注册</button>
